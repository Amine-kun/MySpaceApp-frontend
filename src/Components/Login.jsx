        ...
        <div className="flex justify-center items-center bg-gradient-to-r from-cyan-500 to-blue-700 h-full">
            <div className="flex flex-col items-center justify-center gap-5">
                   <div className="flex flex-col items-center gap-3">
                         <p className="text-5xl text-gray-50 font-bold text-center">Login and Signup</p>
                               ...
                               render={(renderProps)=>(
                                   ...
                                   <button
                                    ...
                                    disabled={renderProps.disabled}
                                     className="bg-gray-50 cursor-pointer flex items-center justify-center gap-1 w-200 px-10 py-2 text-sm text-white border border-gray-300 rounded-full hover:shadow-lg hover:bg-gray-200">
